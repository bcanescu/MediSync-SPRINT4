...
import ProfileScreen from './assets/Auth Group/Doctor/DoctorProfile'
...
import GetDataForUserIstoricMedical from './assets/IstoricMedical/GetDataForUserIstoricMedical';
...
type RootStackParamList = {
  IstoricMedicalQRcode: { email: string },
  IstoricMedical: { email: string },
  ...
  return (
    <NavigationContainer>
      <RootStack.Navigator screenOptions={{ headerShown: false }}>
        ...
        <RootStack.Screen name="IstoricMedical" component={GetDataForUserIstoricMedical} initialParams={{ email: '' }}/>
        <RootStack.Screen name="IstoricMedicalQRcode" component={FrameForQRcodeGeneration} initialParams={{ email: '' }}/>
        ...
        <RootStack.Screen name="DoctorProfile" component={ProfileScreen}/>
      </RootStack.Navigator>
    </NavigationContainer>
  );
};
