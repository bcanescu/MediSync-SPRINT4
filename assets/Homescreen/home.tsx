...
<Image
  source={require('../home.png')}>
      ...
      {
        userState == "Doctor" && <TouchableOpacity onPress={() => nav.push("DoctorProfile")} style={[styles.button, styles.googleButton]}>
          <Text style={styles.buttonText}>Profilul meu </Text>
        </TouchableOpacity>
      }
